...
def run_test_factorial():
    ...
    # Test 5:
    answer_from_oracle = math.factorial(76)
    answer_from_my_code = factorial(76)
...
def run_test_count_cosines_from():
    ...
    # Test 1:
    expected = 2
    answer = count_cosines_from(2, 8, 0.4)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)
    # Test 1:
    expected = 4
    answer = count_cosines_from(1, 7, 0.15)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)
    # Test 1:
    expected = 2
    answer = count_cosines_from(6, 9, 0.21)
...
def run_test_sum_unit_fractions_from():
    ...
    # -------------------------------------------------------------------------
    # Test 2:
    expected = 0.37896825  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(7, 9)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)
    # Test 3:
    expected = 7.48547086  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(1, 1000)
